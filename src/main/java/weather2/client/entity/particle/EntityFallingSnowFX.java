...
public class EntityFallingSnowFX extends EntityRotFX implements WindHandler
{
    ...
    public void onUpdate()
    {
        ...
        //cpw.mods.fml.common.FMLLog.info("this.worldObj.getHeightValue((int)Math.floor(posX), (int)Math.floor(posZ)): " + this.worldObj.getHeightValue((int)Math.floor(posX), (int)Math.floor(posZ)));
